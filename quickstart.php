...
function getClient() {
    ...
    $client->setAuthConfig('application-credentials.json');
    // Set to valid redirect URI for your project.
    $client->setRedirectUri('http://min-makeable-maskine.com/callback/youtube');
...
/*$client->setAccessToken(
  [
    "access_token"=> "ya29.GlvbBHZlUOGZMJ2DD5sX8cA1mN6Zy-yNVMFkvhb1Jzk8H-lIT940zHiX25su_kF23k5INM73IpUYjOLGI9kNi8T8HXH2gksuOpOdpes3sIZ85ZpaTgr8DIaBydkm",
"token_type"=> "Bearer",
"expires_in"=> 3588,
  "created"=> 1507210143
  ]
